...
describe("Search Repository unit tests", () => {
  describe("SearchParams tests", () => {
    ...
    it("perPage prop", () => {
      ...
      params.forEach((element) => {
        expect(new SearchParams({ perPage: element.perPage }).perPage).toEqual(
          element.expected,
        );
      });
    });
    ...
    it("sortDir prop", () => {
      ...
      params.forEach((element) => {
        expect(
          new SearchParams({ sort: "field", sortDir: element.sortDir }).sortDir,
